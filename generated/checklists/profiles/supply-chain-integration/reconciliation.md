...
| SCIR-010 | 4; 5 | CI/CD human and control-plane identity to privileged configuration change | gap |  |  | cicd-platform-security | Establish provider-specific authorization and complete live reconciliation of unrequested changes; the shared runbook is not check evidence. |
