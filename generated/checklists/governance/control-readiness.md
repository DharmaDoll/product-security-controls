...
| Atomic checks | 452 | Assessable catalog rows generated from control metadata. |
| Reviewed mapping checks | 398 | Checks with at least one reviewed framework relationship. |
...
| PSB-SOURCE-003 | source-protection | prototype | E3 | 6 | 5 | 0 | 1 | not-provided | NOT_CHECKED | NOT_CHECKED | NOT_CHECKED | NOT_CHECKED |
