...
control="controls/cicd-security/actions-least-privilege"
...
echo "PASS explicit deny-all workflow and exact job permissions accepted"
echo "PASS implicit broad purpose-mismatched and unguarded permissions rejected"
echo "PASS id-token write and reusable workflow caller permissions constrained"
echo "PASS repository workflows match the reviewed permission policy"
