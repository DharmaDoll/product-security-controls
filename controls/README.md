...
現在、**52 controls / 458 atomic checks**を収録しています。
...
| [Source Protection](#domain-source-protection) | 開発端末、Git、repository、source access credential、公開露出の保護。 | 6 | 79 |
| [Dependency Security](#domain-dependency-security) | registry、cooldown、install script、lockfile、artifact integrityの保護。 | 5 | 32 |
...
| [PSB-DEPS-002](dependency-security/install-script-execution/README.md) | Package managerのnative default denyを維持し、dependency lifecycle script、native build、Python source buildの未承認実行を防ぐ。 | [MITRE ATT&CK](../generated/mappings/mitre-attack.md) / [NIST SSDF](../generated/mappings/nist-ssdf.md) | `prevent`, `verify` | 5 | `prototype` / `E3` |
| [PSB-DEPS-003](dependency-security/lockfile-integrity/README.md) | Native package managerのimmutable installを使い、review済みmanifestとdirect／transitive lock graphの鮮度、lockfile不変性、取得artifact integrityを検証する。 | [MITRE ATT&CK](../generated/mappings/mitre-attack.md) / [NIST SSDF](../generated/mappings/nist-ssdf.md) / [OpenSSF OSPS Baseline](../generated/mappings/openssf-osps-baseline.md) | `prevent`, `verify` | 5 | `prototype` / `E3` |
| [PSB-DEPS-004](dependency-security/dependency-change-review/README.md) | pull requestでbuildやruntimeへ入るdirect／transitive dependency変更を表示し、既知high以上のaffected versionと評価失敗をrequired merge checkで止める。 | [MITRE ATT&CK](../generated/mappings/mitre-attack.md) / [NIST SSDF](../generated/mappings/nist-ssdf.md) / [OpenSSF OSPS Baseline](../generated/mappings/openssf-osps-baseline.md) | `prevent`, `detect`, `verify` | 3 | `reference` / `E3` |
...
| [PSB-CICD-004](cicd-security/actions-least-privilege/README.md) | GitHub Actionsの暗黙権限をdeny-allに置き換え、各jobのGITHUB_TOKENとOIDC発行権限を実際の目的へ限定する。 | [GitHub Security Guidance](../generated/mappings/github-security-guidance.md) / [OpenSSF OSPS Baseline](../generated/mappings/openssf-osps-baseline.md) | `prevent`, `verify` | 6 | `reference` / `E1` |
| [PSB-CICD-005](cicd-security/untrusted-pr-boundary/README.md) | PR作成者が変更できるcodeや実行可能stateとprivileged authorityを分離し、権限処理へ移る前にreview可能なtrust boundaryを再確立する。 | [GitHub Security Guidance](../generated/mappings/github-security-guidance.md) / [OpenSSF OSPS Baseline](../generated/mappings/openssf-osps-baseline.md) | `prevent`, `verify` | 6 | `prototype` / `E1` |
| [PSB-CICD-006](cicd-security/audience-bound-oidc-federation/README.md) | GitHub Actionsのworkload identityをAWSのexact audienceとimmutable subjectへ限定し、長期AWS keyを残さず、対象resourceだけの900秒sessionへ交換する。 | [GitHub Security Guidance](../generated/mappings/github-security-guidance.md) / [MITRE ATT&CK](../generated/mappings/mitre-attack.md) / [OpenSSF OSPS Baseline](../generated/mappings/openssf-osps-baseline.md) | `prevent`, `verify` | 8 | `reference` / `E1` |
| [PSB-CICD-007](cicd-security/runner-hardening/README.md) | GitHub-hostedまたはmanaged ephemeral runnerを既定とし、必要なself-hosted runnerを限定groupのJIT one-job fresh computeとして隔離・破棄する。 | [GitHub Security Guidance](../generated/mappings/github-security-guidance.md) / [MITRE ATT&CK](../generated/mappings/mitre-attack.md) / [NIST SSDF](../generated/mappings/nist-ssdf.md) / [OpenSSF OSPS Baseline](../generated/mappings/openssf-osps-baseline.md) | `prevent`, `detect`, `verify` | 9 | `reference` / `E1` |
| [PSB-CICD-009](cicd-security/cache-provenance-isolation/README.md) | GitHub Actions cacheの保存をprotected default branchへ限定し、PRをrestore-only、lookupをexact、内容をhash再検証するdownload cacheへ限定し、privileged jobからcacheを除外する。 | [GitHub Security Guidance](../generated/mappings/github-security-guidance.md) / [OpenSSF OSPS Baseline](../generated/mappings/openssf-osps-baseline.md) / [sitf](../generated/mappings/sitf.md) | `prevent`, `verify` | 7 | `prototype` / `E1` |
