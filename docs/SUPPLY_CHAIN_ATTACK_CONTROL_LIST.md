...
発行条件だけでなくdeployment authorityとの接続にも必要であり、[共通変更管理runbook](runbooks/privileged-changes/README.md)は
...
[共通変更管理runbook](runbooks/privileged-changes/README.md)を起点に確認します。
